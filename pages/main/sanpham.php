...
?>
    ...
    <div class="wrapper_chitiet">
             <div class="hinhanh_sanpham">
                <img style="height: auto; width: auto;" src="admincp/modul/quanlysp/uploads/<?php echo $row_chitiet['hinhanh'] ?>">
        </div> 
        ...
        <form method="POST" action="pages/main/themgiohang.php?idsanpham=<?php echo $row_chitiet['id_sanpham'] ?>">
            ...
            <div class="chitiet_sanpham">
                ...
                <p>Mă sp: <?php echo $row_chitiet['masp'] ?></p>
  ...
  <div id="tabs-content">
    ...
    <img class="img img-responsive" style="display: block; margin-left: auto; margin-right: auto;;" src="admincp/modul/quanlysp/uploads/<?php echo $row_chitiet['hinhanh'] ?>">
