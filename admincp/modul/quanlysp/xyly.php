...
if(isset($_POST['themsanpham'])){
   ...
   if(!empty($_FILES['hinhanh']['name'])){
    ...
    move_uploaded_file($hinhanh_tmp,'uploads/'.$hinhanh);
        ...
        $sql_update ="UPDATE  tbl_sanpham SET tensanpham='".$tensanpham."',masp='".$masp."',giasp='".$giasp."',soluong='".$soluong."',hinhanh='".$hinhanh."',
        tomtat='".$tomtat."',noidung='".$noidung."',tinhtrang='".$tinhtrang."' WHERE id_sanpham='$_GET[idsanpham]'";

        $sql="SELECT * FORM tbl_sanpham WHERE id_sanpham='$_GET[idsanpham]' LIMIT 1 ";
