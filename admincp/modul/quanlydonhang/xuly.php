...
if(isset($_GET['code'])){
    ...
    $quyery_lietke_dh = mysqli_query($mysqli,$sql_lietke_dh);
    ...
    $doanhthu=0;
    while($row = mysqli_fetch_array($quyery_lietke_dh)){
    ...
    if(mysqli_num_rows($query_thongke)==0){
        ...
        $doanhthu = $doanhthu;
        $donhang = 1;
        $sql_update_thongke = mysqli_query($mysqli,"INSERT INTO tbl_thongke (ngaydat,soluongban,doanhthu,donhang) VALUE 
        ('$now','$soluonban','$doanhthu','$donhang')");
